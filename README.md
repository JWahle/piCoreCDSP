# piCoreCDSP
The goal of this project is to provide an easy way to install [CamillaDSP](https://github.com/HEnquist/camilladsp) 3.0.1 including [GUI](https://github.com/HEnquist/camillagui-backend) 3.0.3
