# piCoreCDSP
The goal of this project is to provide an easy way to install [CamillaDSP](https://github.com/HEnquist/camilladsp) 4.1.3 including [GUI](https://github.com/HEnquist/camillagui-backend) 4.1.0
